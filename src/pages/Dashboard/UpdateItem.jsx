            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='my-4'>
                        ...
                        <input type="text" className="input w-full" placeholder="Recipe Name" defaultValue={name} {...register('name', { required: true })} />
                    </div>
                    <div className='flex gap-6 w-full my-4'>
                        ...
                        <div className='flex-1'>
                            ...
                            <input type="number" className="input w-full" placeholder="Price" defaultValue={price} {...register('price', { required: true })} />
                        </div>
                    </div>
                    {/* recipe details */}
